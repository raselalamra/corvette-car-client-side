...
const BookList = () => {
    ...
    useEffect(() => {
        axios.get('https://boiling-sands-30236.herokuapp.com/orderedByEmail?email='+loggedInUser.email)
            .then(res => {
                setOrders(res.data);
            })
    ...
    const handleDeleteService = (id) =>{
        ...
        swal({
            ...
            if (wantDelete) {
                ...
                axios.delete(`https://boiling-sands-30236.herokuapp.com/cancel-order/${id}`)
                    .then(res => {
